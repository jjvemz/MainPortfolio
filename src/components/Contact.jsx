    ...
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/c58af095-94d6-410d-8e57-089eb0a33ff1" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                ...
                <p className='text-gray-300 py-4'> Contacteme para que trabajemos juntos rellenando el formulario o contactandome por mi telefono celular, mi numero es: +56977666273. </p>
            </div>
